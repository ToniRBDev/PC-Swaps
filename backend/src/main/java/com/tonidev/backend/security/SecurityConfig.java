...
public class SecurityConfig {
    ...
    /**
     * Excluye completamente la carpeta de uploads del filtro de seguridad.
     * Las imágenes son recursos públicos que no requieren autenticación.
     *
     * @return el customizador de seguridad web
     */
    @Bean
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring()
                .requestMatchers(AntPathRequestMatcher.antMatcher("/uploads/**"));
    }
